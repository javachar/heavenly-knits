...
const i18n = {
  en: {
    nav: { home: "Home", catalog: "Catalog", about: "About", blog: "Journal", contact: "Contact", instagram: "Instagram" },
  ...
  es: {
    nav: { home: "Inicio", catalog: "Catálogo", about: "Acerca", blog: "Blog", contact: "Contacto", instagram: "Instagram" },
...
/* =========================
   HELPERS
========================= */
const HEADER_H = 72; // altura real del header
...
export default function Page() {
  ...
  // Nav ids
  const navIds = ["home","catalog","about","blog","contact","instagram"];

  // Scroll spy (sin footer)
  const [active, setActive] = useState("home");
  useEffect(() => {
    const idsForSpy = ["home","catalog","about","blog","contact"];
  ...
  return (
    ...
    >
      ...
      <header className={`sticky top-0 z-50 transition-all duration-200 ${scrolled ? "bg-white/60 backdrop-blur-md shadow-sm" : "bg-white/30 backdrop-blur-md"}`}>
        <div className="relative">
          ...
          <div className="max-w-6xl mx-auto h-[72px] px-4 flex items-center gap-4 relative">
            {/* BRAND */}
            <a href="#home" className="flex items-center gap-3 shrink-0 z-10" onClick={(e)=>{e.preventDefault(); scrollToId('home')}}>
              <motion.span
            ...
            <nav className="hidden md:flex items-center md:gap-6 lg:gap-8 text-[15px] uppercase tracking-wide font-sans absolute left-1/2 -translate-x-1/2">
              {navIds.map((id) => (
                <button
                  key={id}
                  onClick={() => id === 'instagram' ? window.open(SETTINGS.instagram, '_blank') : scrollToId(id)}
      ...
      <main className="snap-y snap-mandatory">
        {/* ===== HERO ===== */}
        <section id="home" ref={heroRef} className="relative bg-[--hero] snap-start">
          <motion.div
            initial={{ opacity: 0 }}
          ...
          />
        {/* Altura exacta descontando header */}
        ...
        <section
          id="catalog"
          className="snap-start bg-[--ivory] flex items-start md:items-center"
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <div className="mt-4">
                      <a
                        ...
                        className={`w-full inline-flex items-center justify-center gap-2 px-4 py-2 rounded-2xl text-white shadow-sm transition ${p.checkout && p.checkout !== "#" ? "bg-[--raspberry] hover:brightness-95 active:scale-[0.99]" : "bg-[--graphite-600] opacity-60 cursor-not-allowed"}`}
        ...
        <section
          id="about"
          className="snap-start bg-white flex items-start md:items-center"
          style={{ minHeight: 'calc(100svh - 72px)' }}
        >
          <div className="max-w-6xl mx-auto px-4 w-full py-10 md:py-0">
            ...
            <div className="grid md:grid-cols-[420px_1fr] gap-10 md:items-center">
              ...
              <div className="font-sans max-w-[58ch] text-[clamp(16px,1.05vw,18px)] leading-[1.85] text-[--graphite-700] text-justify">
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative w-[360px] sm:w-[420px] aspect-[1.8/1] z-10">
                  <Image src="/images/logo-white.webp" alt="Heavenly Knits" fill priority decoding="sync" className="object-contain drop-shadow" sizes="(max-width: 640px) 360px, (max-width: 768px) 420px, 420px" />
                </div>
              </div>
            </div>
